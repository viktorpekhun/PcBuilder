...
namespace PcBuilder.Persistence.Migrations
{
    ...
    [Migration("20260329180417_AddLocalizedDescriptions")]
    partial class AddLocalizedDescriptions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Components.Domain.Entities.Cpu", b =>
                {
                    b.OwnsOne("Components.Domain.Entities.LocalizedDescription", "Description", b1 =>
                        {
                            b1.Property<Guid>("CpuId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Components.Domain.Entities.Motherboard", b =>
                {
                    b.OwnsOne("Components.Domain.Entities.LocalizedDescription", "Description", b1 =>
                        {
                            b1.Property<Guid>("MotherboardId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("MotherboardId");

                            b1.ToTable("Motherboards");
